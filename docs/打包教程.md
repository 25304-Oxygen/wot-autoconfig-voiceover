...
[
    ...
    {
        "nickName": "语音包3",
        "bankPath": "abcABC123/yu yin bao1/voiceover.bnk"
    }
]
```
...
*注意：普通语音包与字幕语音包不可在同一语音包文件中混在一起添加，
两个*`json`*文件仅能用于添加对应语音包*
...
```HTML
第一个字符“#”将成为一个占位符<br><br>↑这个字符将在读取时被舍弃。
```
